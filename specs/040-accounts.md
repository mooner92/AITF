...
- **메모리 예산 (12GB 축소 시나리오 기준, [010](010-instance.md) 옵션 A)**:
  총 12GB − OS·기존 서비스(~2.5GB) − 운영자 세션(수업 중 1개로 절제, ~1.5GB) − 여유(~1GB) ≈ **학생 몫 7GB**
  → 두 반이 순차 진행이라 동시 접속은 ~6명: **MemoryMax=1024M / MemoryHigh=800M**. swap 5G가 완충. 리허설(100)에서 실측 조정. (옵션 B로 24GB 유지 시 1536M/1200M로 상향)
