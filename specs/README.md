...
| [180](180-wiki.md) | — | **자동 위키 (학생별·반별·전체)** | In Progress (최소판 가동) | 스킬·토큰 결합, 그래프 화면 |
| [190](190-hermes.md) | — | Hermes Agent 시연 (6·7주차) | Draft | 4~5주차 구축 |
...
6. **학생 서비스용 DNS 레코드 12개 + 터널 ingress → 110** (10주차 전)
7. **학생 간 포트 격리(iptables) 적용 여부 → 110** (방화벽 변경이므로 확인 필요)
