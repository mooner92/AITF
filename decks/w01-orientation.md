...
<span>논문 4편</span>
<span>정보처리기사</span>
<span class="hi">정보보안기사</span>
</div>

??? 여기서 2분. 표를 읽어주지 말고 한 줄씩 학생 언어로 — "환경 연구하는 국책 연구원에서 AI 서버를 돌려요", "영국에서 당근마켓 같은 앱을 창업해봤어요", "AI 의료기기가 안전한지 검사하는 기준을 만들었어요", "이 학원에서 2년 동안 대회반을 가르쳤어요". 마지막 줄이 신뢰 포인트 — 처음 보는 강사가 아니라는 것. 에피소드(5.7일 초록불)는 대본 참고. 학생이 아는 것에 빗대어 말한다. 회사 이름·기술 스택은 의미 없다 — "너희가 쓰는 그거"가 통한다. 마지막 한 줄로 긴장을 푼다.
